...
export default function CampDetailPage({ params }: CampDetailPageProps) {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Error loading camp</h1>
      ...
      <div className="min-h-screen bg-gray-50 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8 font-medium">The camp you're looking for doesn't exist.</p>
            <Link href="/camps">
              <Button className="bg-emerald-600 hover:bg-emerald-700 font-semibold">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Camps
  ...
  const campData = {
    ...
    amenities: camp.amenities ? camp.amenities.split(',').map((amenity: string) => ({
    ...
    host: {
      ...
      rating: 4.5,
      description: "Experienced local host providing authentic Mongolian hospitality."
    },
    ...
    location_details: {
      nearbyAttractions: [],
      transportation: "4WD vehicle recommended. Contact host for transfer arrangements."
    }
  }
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {campData.images.slice(0, 4).map((image: string, index: number) => (
                  <button
                    key={index}
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                <div>
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 font-display">{campData.name}</h1>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600 ml-1 font-medium">({campData.reviewCount} reviews)</span>
                    </div>
                  </div>
                </div>
              ...
              <p className="text-gray-700 mb-6 font-medium">{campData.description}</p>
              <p className="text-gray-600 text-sm leading-relaxed font-medium">{campData.longDescription}</p>
            </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h3 className="font-bold text-gray-900 mb-2">{campData.accommodation.type}</h3>
                      <div className="space-y-2 text-sm text-gray-600">
                        <div className="flex justify-between">
                          <span className="font-medium">Capacity:</span>
                          <span className="font-semibold">{campData.accommodation.capacity}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="font-medium">Total Units:</span>
                          <span className="font-semibold">{campData.accommodation.totalGers}</span>
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1 text-sm text-gray-600">
                        {campData.accommodation.facilities.map((facility: string, index: number) => (
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-bold text-lg">{campData.host.name}</h3>
                        <div className="flex items-center">
                          <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 mr-1" />
                          <span className="text-sm font-semibold">{campData.host.rating}</span>
                        </div>
                      </div>
                      <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-3">
                        <span className="font-medium">{campData.host.experience} hosting experience</span>
                        <span className="font-medium">Languages: {campData.host.languages.join(", ")}</span>
                      </div>
                      <p className="text-gray-700 text-sm font-medium">{campData.host.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Reviews ({campData.reviewCount})</h2>
                <div className="flex items-center">
              ...
              <div className="space-y-6">
                {campData.reviews.slice(0, showAllReviews ? campData.reviews.length : 3).map((review: any) => (
              ...
              {campData.reviews.length > 3 && (
                ...
                >
                  {showAllReviews ? "Show Less" : `Show All ${campData.reviewCount} Reviews`}
                </Button>
              )}
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {campData.location_details.nearbyAttractions.map((attraction: any, index: number) => (
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700 font-medium">{campData.location_details.transportation}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{campData.policies.checkIn}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 font-medium">Check-out:</span>
                        <span className="font-semibold">{campData.policies.checkOut}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 font-medium">Children:</span>
                        <span className="font-semibold">{campData.policies.children}</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600 font-medium">Pets:</span>
                        <span className="font-semibold">{campData.policies.pets}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 font-medium">Smoking:</span>
                        <span className="font-semibold">{campData.policies.smoking}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 font-medium">{campData.policies.cancellation}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    <span className="text-2xl font-bold">${campData.price}</span>
                    <span className="text-sm text-gray-600 font-medium">per night</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-600 font-medium">You won't be charged yet</p>
                  </div>
