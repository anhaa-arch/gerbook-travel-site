...
export const sendMail = async ({ email, msg }: EmailParams): Promise<void> => {
                        ...
                        <tr>
                          <td align="left">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                <tr>
                                  <td> <a href="http://htmlemail.io" target="_blank">${msg}</a> </td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
...
`;
    ...
    const mailOptions = {
      from: "<info@top-genius.mn>", // Sender address
      to: email,
      subject: "Нууц үг сэргээх", // Subject line
